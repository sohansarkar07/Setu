              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-2 mb-8">
                    ...
                    <div>
                      <div className="text-[10px] uppercase tracking-wider font-semibold mb-1" style={{ color: 'var(--text-muted)' }}>AI Risk Tier</div>
                      <div className={`text-sm font-bold flex items-center gap-1 ${inv.riskTier === 'A' ? 'text-[var(--neon-green)]' : inv.riskTier === 'B' ? 'text-[var(--warning)]' : 'text-[var(--danger)]'}`}>
                        {inv.riskTier ? `Tier ${inv.riskTier}` : 'Tier B'} <Shield size={12} />
                      </div>
                    </div>
                  </div>
